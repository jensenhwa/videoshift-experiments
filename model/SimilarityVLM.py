...
class SimilarityVLM(ABC):
    ...
    def video_cache_key(self, video_path: str, subvideo_start_frame: Optional[int] = None,
                        subvideo_end_frame: Optional[int] = None) -> str:
    ...
    def get_video_embeds(self, video_path: str, subvideo_start_frame: Optional[int] = None,
        ...
        :return:
        """
        cache_item_key = self.video_cache_key(video_path, subvideo_start_frame=subvideo_start_frame,
                                              subvideo_end_frame=subvideo_end_frame)
        if self.disk_cache is not None and cache_item_key in self.disk_cache:
            return self.disk_cache[cache_item_key]

        vid_embed = self.video_encoder(video_path, subvideo_start_frame=subvideo_start_frame,
                                       subvideo_end_frame=subvideo_end_frame)
